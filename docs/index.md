...
| Local parsers | `parseGDS`, `parseGPL`, `parseGSM`, `parseGSE`, `parseGSEMatrix`, `parse_gse_matrix` |
| Conversions | `GDS2MA`, `GDS2eSet`, `gds_to_ma`, `gds_to_expression_set`, `join_gpl_annotations` |
...
- [Cookbook]({{ '/cookbook/' | relative_url }}) gives focused recipes for annotation, typed tables, and release checks.
